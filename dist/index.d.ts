...
declare namespace tt {
    ...
    interface Map extends tt.Evented {
         ...
         * https://developer.tomtom.com/maps-api/maps-api-documentation-vector/tile#request-data.
         */
         ...
         * can be obtained from the list of: {@link https://developer.tomtom.com/maps-api/maps-api-documentation-vector/tile#listOfSupportedLanguages|Supported Languages} page.
         */
